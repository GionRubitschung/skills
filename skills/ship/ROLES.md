...
When any fails, post a comment headed "**Verify** — red", one line per failing command: "- [high] <command> — " followed by the last 15 lines of its output; final line: `verify <slug>: red, <n> high`.
